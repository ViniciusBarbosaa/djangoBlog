...
class PostIndex(ListView):
    ...
    def get_context_data(self, *, object_list=None, **kwargs):
        contexto = super(PostIndex, self).get_context_data(**kwargs)
...
#         self.contexto = {
#             'post': post,
#             'comentarios': Comentarios.objects.filter(post_comentario=post, publicado_comentario=True),
#             'form': FormComentario(request.POST or None),
#         }
#
#         super(PostDetalhes, self).setup(request, *args, **kwargs)
#
...
#         comentario.save()
#         messages.add_message(self.request, messages.SUCCESS, 'Enviado com sucesso')
#
#         return redirect('post_detalhes', pk=self.post.id)
...
class PostDetalhes(UpdateView):
    ...
    def get_context_data(self, **kwargs):
        ...
        post = self.get_object()
        comentarios = Comentarios.objects.filter(publicado_comentario=True,
